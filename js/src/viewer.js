...
Viewer.prototype._bindHandlers = function () {
    ...
    $('table', this._contents).each(function () {
        ...
        if (table.find(".ixbrl-element").length > 0) {
            ...
            $('<div class="ixbrl-table-handle"><span>Export table</span></div>').appendTo(table).click(function () { viewer.exportTable(table); });
        }
    });
}

Viewer.prototype._getRawTable = function (table) {
    var viewer = this;
    var rows = [];
...
Viewer.prototype._getFactsInSlice = function (slice) {
    var facts = [];
...
Viewer.prototype._getConstantAspectsForSlice = function (slice, aspects) {
...
Viewer.prototype._getColumnSlice = function (x) {

}

Viewer.prototype.exportTable = function (table) {
    var data = this._getRawTable(table);
    var rowLength = 0;
