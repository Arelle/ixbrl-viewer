...
class TestIXBRLViewer:
    def setup_method(self, method):
        self.usd_qname = Mock(localName="USD", prefix="iso4217", namespaceURI="http://www.xbrl.org/2003/iso4217")

        self.monetary_type = Mock(
            qname=Mock(localName="monetaryItemType", prefix="xbrli", namespaceURI="http://www.xbrl.org/2003/instance")
        )

        self.string_type = Mock(
            qname=Mock(localName="stringItemType", prefix="xbrli", namespaceURI="http://www.xbrl.org/2003/instance")
        )

        self.integer_simple_type = Mock(
            qname=Mock(localName="integer", prefix="xs", namespaceURI="http://www.w3.org/2001/XMLSchema")
        )
        ...
        self.cash_concept = Mock(
            qname=Mock(localName="Cash", prefix="us-gaap", namespaceURI="http://viewer.com"),
            balance="debit",
        ...
        to_concept = Mock(
            qname=Mock(localName="to_concept", prefix="us-gaap", namespaceURI="http://viewer.com"),
            balance="credit",
            isTypedDimension=False,
            type=self.monetary_type,
        )
        from_concept = Mock(
            qname=Mock(localName="from_concept", prefix="us-gaap", namespaceURI="http://viewer.com"),
            balance=None,
            isTypedDimension=False,
            type=self.monetary_type,
        )
        ...
        dimension_concept = Mock(
            qname=Mock(localName="dimension", prefix="us-gaap", namespaceURI="http://viewer.com"),
            balance=None,
            isTypedDimension=False,
        ...
        typed_dimension_domain_concept = Mock(
            qname=Mock(localName="typed_dimension_domain", prefix="us-gaap", namespaceURI="http://viewer.com"),
            balance=None,
            isTypedDimension=False,
            type=self.string_type,
        )
        ...
        typed_dimension_concept = Mock(
            qname=Mock(localName="typed_dimension", prefix="us-gaap", namespaceURI="http://viewer.com"),
            balance=None,
        ...
        member_concept = Mock(
            qname=Mock(localName="member", prefix="us-gaap", namespaceURI="http://viewer.com"),
            balance=None,
            isTypedDimension=False,
            type=self.string_type,
        )

        rel = Mock(fromModelObject=from_concept, toModelObject=to_concept, weight=1)
        ...
        dimension_missing_member = Mock(
            dimensionQname=dimension_concept.qname, memberQname=None, dimension=dimension_concept, typedMember=None
        )
        ...
        context_2 = Mock(
            entityIdentifier=("scheme", "ident"), qnameDims={}, isInstantPeriod=None, isStartEndPeriod=None
        )
        ...
        file_1 = Mock(filename="something/reports/001.jpg")

        file_2 = Mock(filename="something/reports/002.jpg")

        fs = Mock(filelist=[file_1, file_2])

        file_source = Mock(fs=fs)
        ...
        def relationshipSet_effect(self, *args):
            return Mock(fromModelObject=fromModelObjects_effect, modelRelationships=[rel])
        ...
        def urlDocEntry(path, docType, linkQName=None):
            return path, Mock(
                ...
                xmlRootElement=Mock(iterchildren=Mock(return_value=[Mock(qname=linkQName)] if linkQName else [])),
            )
        ...
        self.modelXbrl_1 = Mock(
            ...
            urlDocs=dict(
                (
                    ...
                    urlDocEntry(
                        "https://example.com/remote-label-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkLabelLink
                    ),
                    urlDocEntry("/filesystem/local-pres-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkPresentationLink),
                    urlDocEntry(
                        "https://example.com/remote-pres-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkPresentationLink
                    ),
                    urlDocEntry("/filesystem/local-calc-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkCalculationLink),
                    urlDocEntry(
                        "https://example.com/remote-calc-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkCalculationLink
                    ),
                    urlDocEntry("/filesystem/local-def-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkDefinitionLink),
                    urlDocEntry(
                        "https://example.com/remote-def-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkDefinitionLink
                    ),
                    urlDocEntry("/filesystem/local-ref-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkReferenceLink),
                    urlDocEntry(
                        "https://example.com/remote-ref-linkbase.xml", Type.LINKBASE, XbrlConst.qnLinkReferenceLink
                    ),
                    urlDocEntry(
                        "/filesystem/local-unrecognized-linkbase.xml",
                        Type.LINKBASE,
                        qname("{http://www.example.org/linkbase}link:unrecognizedLink"),
                    ),
                    urlDocEntry(
                        "https://example.com/remote-unrecognized-linkbase.xml",
                        Type.LINKBASE,
                        qname("{http://www.example.org/linkbase}link:unrecognizedLink"),
                    ),
                )
        ...
        self.cntlr_mock = Mock(logHandler=Mock(logRecordBuffer=self.logRecordBuffer))
    ...
    def test_createViewerWithValidation(self):
        ...
        assert set(jsdata["sourceReports"][0]["targetReports"][0]["facts"]) == {
            "fact_id1",
            "fact_typed_dimension",
            "fact_dimension_missing_member",
        }
    ...
    def test_createViewer(self):
        ...
        assert reportData["concepts"] == {
            ...
            "us-gaap:typed_dimension": {
                "d": "t",
                "e": True,
                "t": True,
                "labels": {},
                "td": "us-gaap:typed_dimension_domain",
                "dt": "xs:integer",
            },
        }
    ...
    def test_createViewer_docset(self):
        ...
        assert jsdata["sourceReports"][0]["docSetFiles"] == ["a.html", "b.html"]
